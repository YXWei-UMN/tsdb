...
regions = ["cn-central-2", "cn-central-1", "cn-west-2", "cn-west-1", "cn-east-2", "cn-east-1", "us-east-1", "us-east-2", "us-west-1", "us-west-2", "eu-west-1", "eu-central-1", "ap-northeast-1", "ap-northeast-2", "ap-southeast-1", "ap-southeast-2", "ap-south-1", "sa-east-1"]
...
with open("/home/local/ASUAD/ywei103/test_data/devops100000.txt", "r") as f1, open("TS_80M", "w") as f2:
    ...
    while line:
        ...
        for x in range(223):
            ...
            items[3] = "datacenter=" + regions[rid] + str(chr(ord('a') + random.randint(0, 20)))
